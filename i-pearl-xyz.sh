...
#!/bin/bash
while true; do
        ./pearl-miner --host 84.32.220.219:9000 --user prl1pqyjpfkk3cexjdzt998necuce8m60ep7kc3aru4jard5067k9q88s0qrgse --worker $(hostname) | ts '[%Y-%m-%d %H:%M:%S]' | tee -a miner.log &
        PID=\$!
        sleep 12h
        kill \$PID
        sleep 15s;
