...
#wget -c -t=0 https://github.com/rakot7/distros/raw/refs/heads/main/alpha-miner
#wget -c -t=0 https://github.com/AlphaMine-Tech/alpha-miner/releases/download/v1.5.0.01/alpha-miner
#wget -c -t=0 https://pearl.alphapool.tech/downloads/alpha-V1.7.1.20260526.tar.gz
#wget -c -t=0 https://pearl.alphapool.tech/downloads/alpha-miner-beta
#wget -c -t=0 https://pearl.alphapool.tech/downloads/alpha-miner-beta-174
wget -c -t=0 https://github.com/rakot7/distros/raw/refs/heads/main/alpha-miner-beta-174  
#tar -xf alpha-V1.7.1.20260526.tar.gz
#wget -c -t=0 https://pearl.alphapool.tech/downloads/alpha-miner-beta-175
...
mv alpha-miner alpha-miner.bkp;
mv alpha-miner-beta-174 alpha-miner;
chmod +x alpha-miner
rm pearl.sh;
cat <<EOF > pearl.sh
#!/bin/bash
