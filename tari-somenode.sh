...
if pgrep -f "glytex" > /dev/null; then
        ...
        while true; do
                ./glytex --tari-address 124NX9ZyKTgVX7inipnBWAxq2sgC7eNEjkhgk5efYS7Ms9FSaqJsDPd2qmjmx6TrAs2rLUjvQewxUKVWJhDeELnJBXR --tari-node-url http://91.99.63.87:5556 --grid-size 1024 --template-timeout-secs 5 --engine OpenCL --coinbase-extra v3,gBHAp7QDawX3nBS6LRovR54grUeM,1.0.0,J+UU1a80L+5hh5snSr7A23dRwp9gD7njuXVvO9fNY04 --p2pool-enabled
                PID=\$!
                sleep 6h
                kill \$PID
                sleep 15s;
