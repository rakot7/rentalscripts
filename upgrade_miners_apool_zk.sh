...
wget --continue --tries=0 https://github.com/apool-io/apoolminer/releases/download/v2.7.0/apoolminer_linux_autoupdate_v2.7.0.tar.gz
...
tar -xf apoolminer_linux_autoupdate_v2.7.0.tar.gz
...
cp ./apoolminer_linux_autoupdate_v2.7.0/apoolminer ./ap/
rm -R apoolminer_linux_autoupdate_v2.7.0
rm -R aleo_prover
cd ap
