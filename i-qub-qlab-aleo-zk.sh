...
cat <<EOF > appsettings.json
{
  "ClientSettings": {
    ...
    "Idling": {
      "gpuOnly": true,
      "command": "./aleo_prover",
      "arguments": "--pool aleo.asia1.zk.work:10003 --pool aleo.hk.zk.work:10003 --pool aleo.jp.zk.work:10003 --address aleo1p5063azmcd5ajzr3nmp9u6ezpta5e9wq7a0dnq5h75vm26x0h58st00ws2 --custom_name 13013",
      "preCommand": null,
