...
mkdir pearl
cd pearl
wget -c -t=0 https://github.com/doktor83/SRBMiner-Multi/releases/download/3.5.7/SRBMiner-Multi-3-5-7-Linux.tar.gz
tar -xf SRBMiner-Multi-3-5-7-Linux.tar.gz
mv ./SRBMiner-Multi-3-5-7/SRBMiner-MULTI ./
rm pearl.sh;
cat <<EOF > pearl.sh
#!/bin/bash
while true; do
        ./SRBMiner-MULTI --algorithm pearlhash --pool  stratum+tcp://hero.hash2grm.com:3336 --wallet prl1pv9r3vsfupa9y9gqha9ncjk3t03a3lwsyct5xnawe5v906lugh6us8tl8p5.$(hostname) &
        sleep 6h
        kill \$PID
        sleep 15s;
done;
